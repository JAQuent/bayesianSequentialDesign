...
- The result is $p(data | H_0) = 0.01096585$.
...
- BF don't protect your from wrong decision but they quantify evidence and have better properties.   
...
- Configured right, there is high likelihood of obtaining strong evidence regardless of effect size. 
- The interpretation of BF does not depend on stopping rules (unlike p-values; Rouder, 2014).
- Consistency property of BFs guarantees that we don't have collect data forever.
